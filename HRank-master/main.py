...
if args.dataset == 'cifar10':
    ...
    train_dataset = my_Data_Set('/home/wxz/United-Perception-main/my_data_path/train.txt',
                                transform=data_transforms['train'], loader=Load_Image_Information)
    test_dataset = my_Data_Set('/home/wxz/United-Perception-main/my_data_path/train.txt',
